...
export default function Dashboard() {
  return (
    <>
      <main class="ease-soft-in-out bg-gray-100 xl:ml-68.5 relative h-full  rounded-xl transition-all duration-200">
                ...
                <div class="flex-auto p-4">
                  <div class="flex flex-wrap -mx-3">
                    ...
                    <div class="max-w-full px-3 mt-12 ml-auto text-center lg:mt-0 lg:w-5/12 lg:flex-none">
                      <div class="h-full bg-gradient-to-tl from-green-700 to-white rounded-xl">
                        <img
                          src="https://media.flaticon.com/dist/min/img/stickers/creativity.png"
