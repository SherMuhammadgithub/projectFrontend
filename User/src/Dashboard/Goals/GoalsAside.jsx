...
export default function GoalsAside({ totalGoals }) {
  ...
  return (
    <aside>
      <div class=" h-80  md:w-[26rem] mx-auto bg-gray-100 rounded-xl shadow-2xl">
        ...
        <div className="header text-center">
          <div className="text-xl font-bold relative">
            ...
            <div className="absolute bottom-2 right-24  md:right-36 h-6 w-6 text-xs rounded-full bg-green-500 text-white flex justify-center items-center">
              {totalGoals}
            </div>
          </div>
        </div>
        ...
        >
          {categorizedGoals.length === 0 ? (
            <div className="text-center text-xl text-gray-600 p-24">
              No goals to display
            </div>
          ) : (
            categorizedGoals.map((goal) => (
              <div
                key={goal.title}
                className={`relative group cursor-pointer overflow-hidden shadow-lg h-[11.5rem] w-72 rounded-2xl hover:duration-700 duration-700 bg-${
              ...
              >
                <div className={`w-72 h-72 text-white p-2`}>
                ...
                <div className="absolute bg-gray-50 -bottom-24 w-72 p-3 flex flex-col gap-1 group-hover:-bottom-0 group-hover:duration-600 duration-500">
