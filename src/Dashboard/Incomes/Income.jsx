...
export default function Income() {
  ...
  return (
    ...
    <div className="w-1/2 flex justify-end items-center">
      {/* popup button */}
<button className="btn bg-[#07271f] rounded-btn text-lg text-white" onClick={()=>document.getElementById('my_modal_5').showModal()}>Add Income</button>
{/* open popup dialog */}
...
<div className="">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        ...
        {incomes.length === 0 ? (
        <p className="flex justify-center items-center w-full py-10 text-xl text-gray-500">No incomes to display</p>
        ):(
        incomes.map((income) => {
