...
function Navigation({ active, setActive }) {
    ...
    return (
        <>
         <div className={`absolute top-8 z-50 transition-all duration-500  ${click?"bg-white text-green-400 left-48":"bg-[#07271f] text-white left-4"} h-10 w-10 flex justify-center items-center rounded-full
            `}>
...
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-align-justify"><line x1="21" y1="10" x2="3" y2="10"></line><line x1="21" y1="6" x2="3" y2="6"></line><line x1="21" y1="14" x2="3" y2="14"></line><line x1="21" y1="18" x2="3" y2="18"></line></svg></button>
        ...
        <NavStyled className={`bg-[#07271f] absolute md:relative  h-screen z-20  text-white  space-y-10 p-12  rounded-lg mt-2 mr-2 mb-2 overflow-y-auto transition-all duration-500 ${click?"translate-x-[100]":"translate-x-[-100%]"}`}   >
            ...
            <Link to={'/'} rel="noreferrer"onClick={() => signOut()}>
                      {settings} Sign Out
                </Link>
            </div> 
        </NavStyled>
