...
export default function NotificationLayout() {
  const { getNotification, notification,deleteNotification } = useGlobalContext();
  useEffect(() => {
    getNotification();
  }, []);
  return (
    <section section className="animate__animated animate__fadeIn">
      ...
      <main className="recent-activity  flex justify-center items-center space-x-16 mb-4 ">
        <div
          class=" col01 p-5 w-full bg-gray-100 h-[35rem] overflow-y-scroll  border mx-16 md:mx-32 mb-10 md:my-10 border-gray-100 rounded-lg bg-gray dark:bg-gray-800 dark:border-gray-700"
