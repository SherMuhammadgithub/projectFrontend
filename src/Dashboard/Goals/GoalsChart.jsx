...
function GoalsChart() {
  ...
  return (
    <div className="chart-container shadow-2xl">
      <div className="h-80 w-[36rem] rounded-md bg-transparent p-8 flex justify-center items-center">
        <div className="bg-white rounded-md w-[34rem] h-72 p-4 flex justify-center items-center">
          <Line data={data} />
        </div>
      </div>
    </div>
